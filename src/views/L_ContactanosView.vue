  ...
  <section id="contacto" class="main-section">
    <div class="contacto-container">
      <div class="informacion">
        <h1 class="title-informacion">Contacto Profesional</h1>
        <div class="informacion-content">
          <p><strong>Teléfono:</strong> +54 9 11 5527-1430</p>
          <p><strong>Correo Electrónico:</strong> lsa.sea.ong@gmail.com</p>
          <p><strong>Horario de Atención:</strong> Lunes a Viernes: 9:00am - 5:00pm, Sábado: 9:00am - 1:00pm, Domingo: Cerrado</p>
        </div>
      </div>
    </div>
  </section>
